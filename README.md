...
- **Управление пользователями**: регистрация, аутентификация и просмотр информации о пользователе, которая включае в себя: информацию при регистрации "id","name","role", "email"; баланс на кошельке, а также все транзакции, которые были произведены на аккаунте (пока это покупка тарифа и пополнение баланса. В будущем активным пользователям будет бонус.)
...
- **Тарифы и компьютеры**: возможность просмотреть информацию о компьютерах, а также посмотреть перечень всех тарифов, которые есть.
