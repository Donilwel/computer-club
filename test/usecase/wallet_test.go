	...
	}{
		{
			...
			mockSetup: func(userRepo *mocks.UserRepository, walletRepo *mocks.WalletRepository, userID int64) {
				...
				transactions := []models.Transaction{
					{ID: 1, UserID: userID, Amount: 100.00, Type: models.Buy},
					{ID: 2, UserID: userID, Amount: 50.00, Type: models.Add},
				}
				walletRepo.On("GetTransactions", mock.Anything, userID).Return(transactions, nil)
			},
			expectedError: nil,
			expectedData: []models.Transaction{
				{ID: 1, UserID: 42, Amount: 100.00, Type: models.Buy},
				{ID: 2, UserID: 42, Amount: 50.00, Type: models.Add},
			},
		},
		{
			name:   "User Not Found",
